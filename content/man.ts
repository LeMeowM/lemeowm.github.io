// Manual pages shown by `man <command>`.
//
// Each key must match a command name in src/commands/meta.ts. Man.tsx derives
// the NAME line from the first sentence of `description`, so keep that sentence
...
export const manPages: Record<string, ManPage> = {
  ...
  motd: {
    synopsis: "motd",
    description:
      "Display the message of the day — a rotating daily tip. The tip array lives in content/tips.ts.",
    examples: ["motd"],
  },
  neofetch: {
    synopsis: "neofetch",
  ...
  skills: {
    synopsis: "skills",
    description:
      "Display a breakdown of programming language proficiency levels and domain specialisms. Data lives in content/skills.ts.",
    examples: ["skills"],
  },
  whoami: {
    synopsis: "whoami",
